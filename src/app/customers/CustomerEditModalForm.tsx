...
export default function CustomerEditModalForm({onSave}: Props) {
    ...
    const registerCustomer = useCallback(async () => {
        ...
        try {
            const res = await apiClient.post<Customer>("/api/customers", {
                name: customerName,
    ...
    }, [apiClient, customerEndDate, customerName, customerStartDate, customerUnitPrice, onSave])
