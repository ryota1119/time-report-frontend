...
type ValueType<T extends InputType, N extends boolean> =
    T extends 'number'
        ? N extends true
            ? number | null
            : string
...
interface Props<T extends InputType, N extends boolean> {
    label?: string;
    type: T;
    id: string;
    value: ValueType<T, N>;
...
export const Input = <T extends InputType, N extends boolean = false>({
                                               label,
                                               type,
                                               id,
                                               value,
